...
class Trip:
    ...
    def calculate_total_bill(self):
        ...
        if self.__distance_travelled_in_km <= self.__pricing_strategy.get_base_distance():
            return self.__distance_travelled_in_km * self.__pricing_strategy.get_base_price() + self.__total_fine
    ...
    def update_fine(self, current_time):
        ...
        if hours_difference > 8:
            self.__total_fine = self.__total_fine + math.ceil(hours_difference / 24) * self.__pricing_strategy.get_fine_per_day()
